# Generated by Powerlevel10k configuration wizard on 2025-06-11 at 11:50 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: nerdfont-v3 + powerline, small icons, unicode, lean, 2 lines,
# disconnected, right frame, light-ornaments, compact, many icons, fluent,
...
() {
  ...
  # Context color in SSH without privileges (make it pop vs local).
  ...
  # Show context (user@host) even when local and non-root.
  # To hide it outside of SSH/root, set this back to an empty expansion.
